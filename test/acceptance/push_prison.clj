...
(def prisoners
  ...
  :inputs {:input!1 :floats-replace, :input!2 "าǴ݉ੴ๩ߝ఺ŷວʙટชᇙΠȖ়", :input!3 [\Ҡ \ \ௗ \ݲ \ྪ \ᄋ], :input!4 :floats-emptyitem?, :input!5 :string-replacefirstchar, :input!6 :boolean-return, :input!7 :char->string, :input!8 :set-subset?, :input!9 [4191 1087 1982 2405 917 2469 4206 1037 1141]}
