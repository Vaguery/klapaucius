...
(tabular
  (fact "`foo-cutstack` takes an :scalar, divides the stack into two parts at that index (measured from the top), and puts the top segment at the bottom"
    ...
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    {:foo      '(9 8 7 6 5 4)
     :scalar  '(-2.77)}         :foo-cutstack      {:foo      '(6 5 4 9 8 7)
                                                     :scalar  '()}
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    {:foo      '(9 8 7 6 5 4)
    ...
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    {:foo      '(9 8 7 6 5 4)
     :scalar  '(-97/9)}         :foo-cutstack      {:foo      '(8 7 6 5 4 9)
                                                     :scalar  '()}
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    {:foo      '()
...
(tabular
  (fact "`foo-cutflip` takes an :scalar, divides the stack into two parts at that index (measured from the top), and puts the top segment at the bottom"
    ...
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    {:foo      '(9 8 7 6 5 4)
     :scalar  '(9/2)}         :foo-cutflip          {:foo      '(6 7 8 9 5 4)
                                                     :scalar  '()}
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    {:foo      '(9 8 7 6 5 4)
     :scalar  '(111.2)}        :foo-cutflip          {:foo      '(7 8 9 6 5 4)
                                                     :scalar  '()}
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    {:foo      '(9 8 7 6 5 4)
